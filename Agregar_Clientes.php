...
<h1 class="titulo">Agregar Clientes</h1>

<p>&nbsp;</p> 
<center>
<form id="Formulario" name="Formulario" method="post" action="Agregar_Clientes2.php" enctype="multipart/form-data">
	<div class="col-4">
		<div class="input-group mb-3">
			<span class="input-group-text" id="inputGroup-sizing-default">Nombre: </span>
			<input type="text" name="NOMBRE_CLIENTE" id="NOMBRE_CLIENTE" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
		</div>
	</div>
	...
	<div class="col-4">
		<div class="input-group mb-3">
			...
			<input type="text" name="DIRECCION" id="DIRECCION" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
		</div>
	</div>
