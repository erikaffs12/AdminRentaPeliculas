...
<h1 class="titulo">Agregar Empleados</h1>

<p>&nbsp;</p> 
<center>
<form id="Formulario" name="Formulario" method="post" action="Agregar_Empleado2.php" enctype="multipart/form-data">
	<div class="col-4">
		<div class="input-group mb-3">
			<span class="input-group-text" id="inputGroup-sizing-default">RFC: </span>
			<input type="text" name="RFC" id="RFC" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
		</div>
	</div>
	...
	<div class="col-4">
		<div class="input-group mb-3">
			...
			<input type="text" name="NOMBRE_EMPLEADO" id="NOMBRE_EMPLEADO" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
		</div>
	</div>
	...
	<div class="col-4">
		<div class="input-group mb-3">
			...
			<input type="date" name="FECHA_NACIMIENTO" id="FECHA_NACIMIENTO" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
		</div>
	</div>
	...
	<div class="col-4">
		<div class="input-group mb-3">
			...
			<input type="date" name="FECHA_INGRESO" id="FECHA_INGRESO" class="form-control"  aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
		</div>
	</div>
