...
$DIRECCION = $_POST['DIRECCION'];
	...
	$sql_cliente="UPDATE CLIENTE SET NOMBRE_CLIENTE='$NOMBRE_CLIENTE', DIRECCION='$DIRECCION'
	WHERE ID_CLIENTE='$ID'";
  ...
  oci_free_statement($stm); 
     ...
     if(!oci_error())
	{
		echo "<center><h1>Registro Actualizado<br><a href='Listar_clientes.php'>Consultar clientes</a></h1></center>";	
	}
	else 
	{
