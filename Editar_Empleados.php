...
<?php 
	...
	while( $fila_empleado = oci_fetch_array($resultado_empleado, OCI_RETURN_LOBS))  // OCI_BOTH OCI_NUM  OCI_ASSOC OCI_RETURN_NULLS   OCI_ASSOC+OCI_RETURN_NULLS  OCI_RETURN_LOBS
	{
?>

<p>&nbsp;</p>
<center>
<form id="Formulario" name="Formulario" method="post" action="Editar_Empleados2.php"  enctype="multipart/form-data">
	<div class="col-4">
		<div class="input-group mb-3">
			<span class="input-group-text" id="inputGroup-sizing-default">ID Empleado: </span>
			<input type="text" name="ID_EMPLEADO" id="ID_EMPLEADO" value="<?php echo $fila_empleado['ID_EMPLEADO'];?>"  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
		</div>
	</div>	
	<div class="col-4">
		<div class="input-group mb-3">
			<span class="input-group-text" id="inputGroup-sizing-default">RFC: </span>
			<input type="text" name="RFC" id="RFC" value="<?php echo $fila_empleado['RFC'];?>"  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
		</div>
	</div>	
	<div class="col-4">
		<div class="input-group mb-3">
			<span class="input-group-text" id="inputGroup-sizing-default">Nombre: </span>
			<input type="text" name="NOMBRE_EMPLEADO" id="NOMBRE_EMPLEADO" value="<?php echo $fila_empleado['NOMBRE_EMPLEADO'];?>"  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
		</div>
	</div>	
	<div class="col-4">
		<div class="input-group mb-3">
			<span class="input-group-text" id="inputGroup-sizing-default">Fecha de nacimiento: </span>
			<input type="date" name="FECHA_NACIMIENTO" id="FECHA_NACIMIENTO" value="<?php echo date('Y-m-d',strtotime($fila_empleado['FECHA_NACIMIENTO']));?>"  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
		</div>
	</div>	
	<div class="col-4">
		<div class="input-group mb-3">
			<span class="input-group-text" id="inputGroup-sizing-default">Fecha de contratación: </span>
			<input type="date" name="FECHA_INGRESO" id="FECHA_INGRESO" value="<?php echo date('Y-m-d',strtotime($fila_empleado['FECHA_INGRESO']));?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
		</div>
	</div>	
	...
	<div class="col-4">
		<div class="input-group mb-3">
			...
			<select name="GENERO_EMPLEADO" id="GENERO_EMPLEADO" class="form-select form-select-sm" aria-label=".form-select-sm example">
				<option value="<?php echo $fila_empleado['GENERO_EMPLEADO'];?>"><?php echo $fila_empleado['GENERO_EMPLEADO'];?></option>
