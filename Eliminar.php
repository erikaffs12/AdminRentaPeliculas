...
<title>Eliminar Multimedia</title>
...
<?php 
	...
	$sql_pelicula="DELETE FROM PELICULA WHERE ID_PELICULA='$ID'";
	...
	if(!oci_error())
	{
		echo "<center><h1>Registro Eliminado<br><a href='Peliculas2.php'>Consultar Multimedia</a></h1></center>";	
	}
	else
	{
