...
<?php 
	...
	$sql_empleado="DELETE FROM RENTAR WHERE ID_RENTA='$id'";
	...
	if(!oci_error())
	{
		echo "<center><h1>Registro Eliminado<br><a href='Listar_Rentas.php'>Consultar rentas</a></h1></center>";	
	}
	else
	{
